...
<div class="container-fluid">
    ...
    <div class="row text-center py-4">
        <h6 class="font-weight-bold">JUSTIFICACION problems CONTROL BIOMETRICO Nº {{ $problems->id }}</h6>
    </div>
    <div class="row pt-1">
    ...
    <div class="row">
        <table class="table table-striped table-bordered table-responsive-sm">
            ...
            <tbody>
            <tr>
                <td nowrap="" class="text-uppercase">{{ Carbon\Carbon::create($problems->fecha_problems)->locale("es")->dayName." ".Carbon\Carbon::parse($problems->fecha_problems)->format('d')." de ".strtoupper(Carbon\Carbon::create($problems->fecha_problems)->locale("es")->monthName)." del año ".Carbon\Carbon::parse($problems->fecha_problems)->format("Y") }}</td>
                <td disabled="">
    ...
    <div class="row pt-3">
        <div class="col">
            ...
            <p class="text-center" style="margin-left: 0%; margin-right: 70%"><strong>Firma Funcionario(a)</strong></p>
        </div>
        <div class="col">
            <hr style="width: 30%;background-color: black;margin-left: 65%;margin-right: 0%;">
            <p class="text-center" style="margin-left: 60%; margin-right: 0%"><strong> Firma Jefe Directo </strong></p>
        </div>
    </div>
    <div class="row">
...
<div class="row">
    <div class="col text-center">
        <span class="font-weight-bold fixed-bottom">En Licanten, a {{ Carbon\Carbon::parse($problems->created_at)->format('d').' de '.\Carbon\Carbon::parse($problems->created_at)->monthName.' de '.\Carbon\Carbon::parse($problems->created_at)->format('Y') }}</span>
    </div>
</div>
<style>
    html {
