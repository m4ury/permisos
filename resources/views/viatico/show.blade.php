        ...
        <div class="row">
            <div class="col pt-3">
                <table>
                    ...
                    <tr><th>LUGAR DEL COMETIDO.: </th><td><u>{{ $viatico->permiso->lugar.', '.$viatico->permiso->comuna }}</u></td><th>FECHA COMETIDO: </th><td><u>{{ Carbon\Carbon::parse($viatico->permiso->dia_inicio)->format("d") }} de {{ Carbon\Carbon::parse($viatico->permiso->dia_inicio)->format("M") }} del {{ Carbon\Carbon::parse($viatico->permiso->dia_inicio)->format("Y") }}</u></td></tr>
